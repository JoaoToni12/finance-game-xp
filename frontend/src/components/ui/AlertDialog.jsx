...
import { buttonVariants } from "./Button"; // Importando do arquivo que criamos acima
...
const AlertDialogAction = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Action
    ref={ref}
    className={cn(buttonVariants(), className)} // Usa o estilo amarelo padrão
    {...props}
  />
));
...
const AlertDialogCancel = React.forwardRef(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel
    ref={ref}
    className={cn(
      buttonVariants({ variant: "outline" }), // Usa o estilo outline (borda cinza)
      "mt-2 sm:mt-0 text-zinc-300 border-zinc-700 hover:bg-zinc-800 hover:text-white",
      className
    )}
    {...props}
  />
